JavaScript (JS)[a] is a programming language and core technology of the Web, alongside [HTML]( /wiki/HTML) and [CSS]( /wiki/CSS). It was created by Brendan Eich in 1995.[6] As of 2025, the overwhelming majority of websites (98.9%) uses JavaScript for client side webpage behavior.
